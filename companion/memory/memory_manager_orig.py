...
# Purpose: Lightweight memory manager with short-term, long-term, and meta-memory support
    ...
    # Add memory
    # memory.add("Ana entered Loop 9 with subtle recursion signs.")
  #  memory.add("Ana breached Gate 11.")

    # Retrieve
#    results = memory.search("What loop is Ana in?")
...
if __name__ == "__main__":
    ...
    mm.add_memory("Ana once told him she prefers peaceful mornings.")
    results = mm.search_memory("What does Ana like?")
    print(results)
